...
Mobile.tap(findTestObject('TODO/1.Dashboard/1.1.TaskOption/android.widget.TextView - Delete'), 0)

Mobile.tap(findTestObject('TODO/1.Dashboard/1.1.TaskOption/android.widget.Button - DELETE'), 0)
